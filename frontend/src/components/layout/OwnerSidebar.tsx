...
import { ownerNavGroups } from '@/lib/nav/owner.nav'
    ...
    <>
      ...
      <aside className={cn(
        ...
        <div className="flex h-14 items-center justify-between border-b px-4">
          <span className="font-semibold text-sidebar-foreground">Kat Maliki Paneli</span>
          <button
        ...
        <nav className="flex-1 overflow-y-auto px-2 py-3">
          <SidebarNavGroups groups={ownerNavGroups} pathname={pathname} />
        </nav>
